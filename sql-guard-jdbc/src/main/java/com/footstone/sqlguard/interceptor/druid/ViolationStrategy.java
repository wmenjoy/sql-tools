...
/**
 * Strategy for handling SQL validation violations at runtime in Druid filter.
 *
 * <p>ViolationStrategy defines how the Druid filter responds when SQL validation violations are
