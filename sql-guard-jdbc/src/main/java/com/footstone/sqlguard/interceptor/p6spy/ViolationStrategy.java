...
/**
 * Strategy for handling SQL validation violations at runtime in P6Spy listener.
 *
 * <p>ViolationStrategy defines how the P6Spy listener responds when SQL validation violations are
 * detected. This allows flexible deployment strategies from observation-only to strict
 * enforcement.</p>
 *
 ...
 *   <li><strong>LOG</strong> - Log warning level message, continue execution (observation
 *       mode)</li>
 * </ul>
 *
