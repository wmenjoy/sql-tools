...
/**
 * Tests to verify all 15 security checkers are registered in the Gradle plugin.
 *
...
class CheckerRegistrationTest {
  ...
  void testAllCheckersRegistered_shouldHave15Checkers() throws Exception {
    ...
    Method method = SqlGuardScanTask.class.getDeclaredMethod("createAllCheckers", SqlGuardConfig.class);
    method.setAccessible(true);
    @SuppressWarnings("unchecked")
    List<RuleChecker> checkers = (List<RuleChecker>) method.invoke(task, config);
