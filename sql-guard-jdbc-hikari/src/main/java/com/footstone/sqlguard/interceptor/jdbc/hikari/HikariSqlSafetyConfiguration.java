 ...
 * </ul>
 *
 * <h2>Example - Programmatic Configuration</h2>
 * <pre>{@code
 ...
 * }</pre>
 *
 * <h2>Example - Spring Boot Auto-Configuration</h2>
 * <pre>{@code
 * @Configuration
 ...
 * }</pre>
 *
 * <h2>Leak Detection Compatibility</h2>
...
public class HikariSqlSafetyConfiguration {
     ...
     */
    private HikariSqlSafetyConfiguration() {
        ...
        return new org.springframework.beans.factory.config.BeanPostProcessor() {
            ...
            public Object postProcessAfterInitialization(Object bean, String beanName) {
                if (bean instanceof HikariDataSource) {
                    ...
                    if (HikariSqlSafetyProxyFactory.isWrapped((DataSource) bean)) {
    ...
    /**
     * Checks if the HikariCP version on classpath supports all proxy features.
     *
     * @return true if HikariCP version is compatible
     */
    public static boolean isHikariCpVersionCompatible() {
        try {
            // Check for HikariDataSource class
            Class.forName("com.zaxxer.hikari.HikariDataSource");
            return true;
        } catch (ClassNotFoundException e) {
            logger.warn("HikariCP not found on classpath");
            return false;
        }
    }
}
